    ...
    <div class="flex-grow-1">
      ...
      <div class="container-fluid px-4">
        ...
        <div class="card p-3 view-card shadow">
          <p><strong>Class Name:</strong> <?php echo htmlspecialchars($classData['name']); ?></p>
          <p><strong>Section:</strong> <?php echo htmlspecialchars($classData['section']); ?></p>
          <p><strong>Teacher:</strong> <?php echo htmlspecialchars($classData['teacher_name']); ?></p>

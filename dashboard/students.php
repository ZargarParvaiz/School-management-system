...
$current_page = basename($_SERVER['PHP_SELF']); // e.g. "students.php"
...
<body>
  <div class="d-flex">
    ...
    <div class="sidebar" style="width: 250px;">
      ...
      <div class="nav flex-column">
        <!-- Conditionally highlight the correct link -->
        <a href="index.php" 
        ...
        <a href="subjects.php" 
           class="nav-link <?php echo ($current_page == 'subjects.php') ? 'active' : ''; ?>">
    ...
    <div class="flex-grow-1">
      ...
      <div class="container-fluid px-4">
        <!-- Display success message if a student was deleted -->
  ...
  <script>
    ...
    function viewStudent(id) {
      // We'll open a new page to view the student's details
      window.location.href = 'actions/view_student.php?id=' + id;
    }

    function editStudent(id) {
      // We'll open a new page to edit the student's data
      window.location.href = 'actions/edit_student.php?id=' + id;
    }

    function deleteStudent(id) {
      if(confirm('Are you sure you want to delete this student?')) {
        // If confirmed, go to delete action
        window.location.href = 'actions/delete_student.php?id=' + id;
      }
    }
  </script>
</body>
